...
def run_preprocess_data(**kwargs):
    # Importar dentro de la función después de que las dependencias estén instaladas
    from task.risk_profiling_dag.preprocess_data import preprocess_data
    return preprocess_data(**kwargs)

# Definir la tarea del DAG utilizando el operador Python y la función definida
